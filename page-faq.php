...
<!-- Page Title -->
<title>Library | Haruna Wakili</title>
          ...
          <div class="col-md-8">
            <div class="widget no-border m-0">
              <ul class="list-inline">
                <li class="m-0 pl-10 pr-10"> <i class="fa fa-phone text-white"></i> <a class="text-white" href="#">(234) 7034 665224</a> </li>
                <li class="text-white m-0 pl-10 pr-10"> <i class="fa fa-clock-o text-white"></i> Mon-Fri 8:00 to 2:00 </li>
                <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-white"></i> <a class="text-white" href="#">harunawakililibrary@slu.edu.ng</a> </li>
              </ul>
            </div>
          </div>
          <div class="col-md-4">
        ...
        <div class="row">
          <div class="col-md-8 col-md-offset-2">
            <div id="accordion1" class="panel-group accordion">
              <div class="panel">
                <div class="panel-title"> <a data-parent="#accordion1" data-toggle="collapse" href="#accordion11" class="active" aria-expanded="true"> <span class="open-sub"></span> <strong>Q. How to create a bibliography, citations, and references in Word?</strong></a> </div>
                <div id="accordion11" class="panel-collapse collapse in" role="tablist" aria-expanded="true">
                  <div class="panel-content">
                    <p>

Microsoft Word has a simple built-in reference function in the References tab.

Please see the MS Word Referencing Tool - Guide and other support material listed below for details on how to automatically format in‐text citations and generate a bibliography or reference list in your Word document.
Links & Files

    MS Word Referencing Tool - Guide
    Create a bibliography, citations, and references
    Add citations in a Word document
    Read more about reference/bibliography list (Write it Right guide)
              ...
              <div class="panel">
                <div class="panel-title"> <a class="collapsed" data-parent="#accordion1" data-toggle="collapse" href="#accordion12" aria-expanded="false"> <span class="open-sub"></span> <strong>Q. Can I borrow journals/theses/exam papers?</strong></a> </div>
                <div id="accordion12" class="panel-collapse collapse" role="tablist" aria-expanded="false" style="height: 0px;">
                  <div class="panel-content">
                    <p>Hardcopy journals, Final Year Projects (FYPs), theses and exam papers may not be borrowed and may only be used in the Library.</p> 
                    <p>Hardcopy journals may only be used in the Library however the library has a large collection of online journals available on and off campus through its online databases..</p>
                  </div>
                </div>
              </div>
              <div class="panel">
        ...
        <div class="section-content text-center">
          <div class="row">
            <div class="col-md-12">
              ...
              <h4>Just call at <span class="text-theme-color-2">07034665224 or mail us via:  harunawakililibrary@slu.edu.ng</span> for emergency service</h4>
            </div>
          </div>
        </div>
      </div>
